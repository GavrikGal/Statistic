...
if __name__ == '__main__':
    ...
    # plotter.show()
    plotter.save(r'd:\WorkSpace\Python\pythonProject\Statistic\data\ВМЦ-61.2ЖК\1903103\Доработка 5 (Уплотнители в задней части корпуса + дораб LVDS)\DVI max [доработка3, доработка4]')
